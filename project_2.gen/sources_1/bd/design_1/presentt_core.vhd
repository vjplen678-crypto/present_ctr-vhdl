...
architecture Behavioral of present_core is
    ...
    -- S-layer
    ------------------------------------------------------------------
    function S_LAYER(b : std_logic_vector(63 downto 0))
        return std_logic_vector is
            ...
            if rstn = '0' then
                ...
                case state is
                    ...
                    when ROUND =>
                        ...
                        tmp_data :=
                            std_logic_vector(
                                unsigned(tmp_data) xor
                                unsigned(tmp_key(79 downto 16))
                            );
                        ...
                        tmp_key(19 downto 15) :=
                            std_logic_vector(
                                unsigned(tmp_key(19 downto 15)) xor
                                unsigned(rc_vec)
                            );
